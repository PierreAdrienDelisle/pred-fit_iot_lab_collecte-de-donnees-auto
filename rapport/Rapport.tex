...
\begin{figure}[hp]
    ...
    \caption{Graphique architecture web FIT IoT Lab [11]}
\end{figure}
...
Dans cette section, nous présenterons les tutoriels essentiels de la plateforme que nous avons dû suivre pour réaliser notre solution.
	\begin{itemize}
		...
		\item Run a script in background [5]
...
\newline
\newline
[5]Running script on SSH frontend - \newline https://www.iot-lab.info/tutorials/iotlab-runscript-client/
\newline
\newline
...
\newline
\newline
[11] Architecture web FIT IoT Lab - \newline https://github.com/iot-lab/iot-lab/tree/master/web-view
...
\section{Ensemble du système - Diagramme d'architecture - Figure 3.1}
Ce diagramme d'architecture représente où sont placés les différentes parties prenantes pour l'exécution de la collecte automatique des données. Ainsi que d'un ordre partiel pour comprendre le mécanisme global.

\section{Scénario - Diagramme de séquence - Figure 3.2}
