...
Dans cette section, nous présenterons les tutoriels essentiels de la plateforme que nous avons dû suivre pour réaliser notre solution.
	\begin{itemize}
		...
		En prenant exemple sur le script "serial aggregator", ce tutoriel permet de mettre en place une exécution automatique d'un script directement à la soumission d'une expérience et d'ensuite récupérer ces logs.
